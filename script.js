...
$(document).ready(function () {
  ...
  // const latLngs = L.GeoJSON.coordsToLatLngs(geoData[0].features[i].geometry.coordinates.ISO_A3,2);
  //L.polyline(latLngs, {
  //  color: "green",
  // weight: 14,
  // opacity: 1
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      map.on("click", function (e, latlng) {
        $.ajax({
          ...
          //2
          //);
          //console.log(geoData[0].features[i]);
          ////L.geoJSON(geoData[0].features[i])
          //   .bindPopup(geoData[0].features[i].properties.ADMIN)
          //   .addTo(map);
          //map.fitBounds(latLngs);
          // $("#select").val(geoData[0].features[i].properties.ADMIN).change();
      ...
      // 2
      //);
      //polygon = L.polygon(latLngs, {color: "green", id: latLngs}).addTo(map);
      ...
      if (localStorage.getItem("city") !== selectedCountry) {
        $.ajax({
          ...
          success: function (res) {
            ...
            console.log(JSONdata2.geonames[1]);
    ...
    $("#form").change(function (e) {
      ...
      // for (i = 0; i < geoData[0].features.length; i++) {
      // console.log(geoData[0].features[i].properties.ISO_A3);
      // if (geoData[0].features[i].properties.ADMIN == selectedCountry) {
      // const latLngs = L.GeoJSON.coordsToLatLngs(
      // geoData[0].features[i].geometry.coordinates,
      //2
      //);
